...
<body>
            ...
            <c:otherwise>
                <c:forEach items="${list}" var="notice">
                    <tr>
                        ...
                        <td>
                            <a href="/client/notice/noticeDetail${pagination.makeQuery(pagination.pageRequest.page)}&noticeNo=${notice.noticeNo}">
                                ${notice.noticeTitle}
                            </a>
                        </td>
    ...
    <div class="pagination">
     <c:if test="${pagination.prev && pagination.endPage > 0}">
          	<a href="/client/notice/noticeList${pagination.makeQuery(pagination.startPage -1)}" >&laquo;</a>
        ...
        <c:forEach begin="${pagination.startPage}" end="${pagination.endPage}" var="idx" >
          ...
          <c:if test="${pagination.next && pagination.endPage > 0}">
          	<a href="/client/notice/noticeList${pagination.makeQuery(pagination.endPage +1)}" >&raquo;</a>

...
<div align="center">
    <table>
        <tr>
        	<div class="font">
            <td width="120"><a href="/client/intro/commpanyintr"><spring:message code="header.intro"/></a></td>
            <td width="120"><a href="/client/notice/noticeList"><spring:message code="header.notice"/></a></td>
